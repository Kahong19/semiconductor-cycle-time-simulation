...
- Fab performance is not driven by process times alone, but by interactions between arrival rate, capacity, and queue dynamics.
- Planning must therefore shift from: Mean-based thinking → Tail-risk and system-level thinking
